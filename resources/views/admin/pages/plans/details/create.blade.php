...
@section('title', "Adicionar novo detalhes ao plano {$plan->name}")
...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('details.plan.create', $plan->url) }}" class="active" >Create</a></li>
    </ol>
